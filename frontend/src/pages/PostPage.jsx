...
const PostPage = () => {
  ...
  return (
     <main className='p-3 flex flex-col max-w-6xl mx-auto min-h-screen bg-white dark:bg-custom-dark'>
     ...
     />
     <div className="flex justify-between items-center p-3 border-b border-slate-300 text-xs mx-auto w-full max-w-2xl">
